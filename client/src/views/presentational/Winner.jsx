...
const Winner = () => {
    ...
    useEffect(() => {
        ...
        let interval = setInterval(() => { nav(`/boards/${diff}`) }, 3000);
    ...
    return (
        ...
        <div style={styles.messageContainer()}>
            ...
            <div style={styles.messageMain()}>
                ...
                <i id="winner-check" style={{ color: "#ffec80", fontSize: "300px", textShadow: "2px 2px 2px mintcream" }} className='fas fa-check' />
            </div>
